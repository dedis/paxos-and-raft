...
./${ctl_path}       --name 13 --requestType request --defaultReplica 2  --debugOn --debugLevel 6 --batchSize 1 --batchTime 1 --arrivalRate "${arrivalRate}" --leaderTimeout "${viewTimeoutTime}" >${output_path}13.log
