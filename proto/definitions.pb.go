...
type PaxosConsensus struct {
	...
	ProposeValue   []*ReplicaBatch           `protobuf:"bytes,9,rep,name=propose_value,json=proposeValue,proto3" json:"propose_value,omitempty"`
...
type PaxosConsensusInstance struct {
	...
	Value  []*ReplicaBatch `protobuf:"bytes,3,rep,name=value,proto3" json:"value,omitempty"`
}
...
var file_proto_definitions_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x52, 0x65, 0x70,
